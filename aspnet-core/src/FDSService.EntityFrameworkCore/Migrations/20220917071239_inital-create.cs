...
namespace FDSService.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DependOnVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackageVersions_Attachments_AttachmentId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageVersions_PackageVersions_DependOnVersionId",
                        column: x => x.DependOnVersionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientPackages_AbpUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientPackages_PackageVersions_CurrentVersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageVersionChannels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackageVersionChannels_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageVersionChannels_PackageVersions_VersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageVersionCountries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackageVersionCountries_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageVersionCountries_PackageVersions_VersionId",
                        column: x => x.VersionId,
                        principalTable: "PackageVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPackages_CurrentVersionId",
                table: "ClientPackages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageVersionChannels_ChannelId",
                table: "PackageVersionChannels",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageVersionChannels_VersionId",
                table: "PackageVersionChannels",
                column: "VersionId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageVersionCountries_CountryId",
                table: "PackageVersionCountries",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageVersionCountries_VersionId",
                table: "PackageVersionCountries",
                column: "VersionId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageVersions_AttachmentId",
                table: "PackageVersions",
                column: "AttachmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageVersions_DependOnVersionId",
                table: "PackageVersions",
                column: "DependOnVersionId");
