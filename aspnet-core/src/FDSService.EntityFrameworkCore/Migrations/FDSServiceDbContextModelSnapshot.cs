...
{
    [DbContext(typeof(FDSServiceDbContext))]
    partial class FDSServiceDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FDSService.Attachments.Attachment", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("FDSService.Clients.ClientPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FDSService.DataLookups.Channel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FDSService.DataLookups.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FDSService.Packages.Package", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("newid()");
            ...
            modelBuilder.Entity("FDSService.Packages.PackageVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("newid()");
                    ...
                    b.Property<Guid?>("DependOnVersionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FDSService.Packages.PackageVersionChannel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PackageVersionChannels", (string)null);
                });

            modelBuilder.Entity("FDSService.Packages.PackageVersionCountry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PackageVersionCountries", (string)null);
                });
            ...
            modelBuilder.Entity("FDSService.Clients.ClientPackage", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FDSService.Packages.PackageVersion", "CurrentVersion")
                        .WithMany("Clients")
                        .HasForeignKey("CurrentVersionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("FDSService.Packages.Package", "Package")
                        .WithMany("Clients")
            ...
            modelBuilder.Entity("FDSService.Packages.PackageVersion", b =>
                {
                    b.HasOne("FDSService.Attachments.Attachment", "Attachment")
                        .WithMany("Versions")
                        .HasForeignKey("AttachmentId");

                    b.HasOne("FDSService.Packages.PackageVersion", "DependOnVersion")
                        .WithMany("Versions")
                        .HasForeignKey("DependOnVersionId");
            ...
            modelBuilder.Entity("FDSService.Packages.PackageVersionChannel", b =>
                {
                    b.HasOne("FDSService.DataLookups.Channel", "Channel")
                        .WithMany("Versions")
                        .HasForeignKey("ChannelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FDSService.Packages.PackageVersion", "Version")
                        .WithMany("Channels")
            ...
            modelBuilder.Entity("FDSService.Packages.PackageVersionCountry", b =>
                {
                    b.HasOne("FDSService.DataLookups.Country", "Country")
                        .WithMany("Versions")
